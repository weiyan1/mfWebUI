...
describe('6.3.1 SS-ES Ops Page After Signin', function () {
    ...
    // Connection Name: SSESOpsConn0001
    ...
    it('Should add a connection successfully', function () {
        browser.sleep(1000).then(function () {
            Page.delConnYes("SSESOpsConn0001");
        }).then(function () {
            Page.addConn("SSESOpsConn0001");
        }).then(function () {
            ...
            expect(message === 'SSESOpsConn0001').to.be.true;
        }).then(function () {
    ...
    // Connection Name: SSESOpsConn0002, SSESOpsConn0002-copy
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Should add a connection, then replicate it successfully', function () {
        Page.delConnYes("SSESOpsConn0002-copy").then(function () {
            Page.delConnYes("SSESOpsConn0002");
        }).then(function () {
            Page.addConn("SSESOpsConn0002");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.replicateConn("SSESOpsConn0002");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            expect(message === 'SSESOpsConn0002-copy').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
            expect(message === browser.params.endpointSSES.url).to.be.true;
    ...
    // Connection Name: SSESOpsConn0003
    ...
    it('Should add a connection, then update it successfully', function () {
        Page.delConnYes("SSESOpsConn0003").then(function () {
            Page.addConn("SSESOpsConn0003", "AbCdEfG:1234", "AAAAA", "bbbbb", false, true);
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.updateConn("SSESOpsConn0003", "HiJkLmN:5678", "CCCCC", "ddddd", true, false);
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleConnNameInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'SSESOpsConn0003').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
    ...
    // Connection Name: SSESOpsConn0004
    ...
    it('Should add a connection, cancel the changes, then confirm the cancel operation', function () {
        Page.delConnYes("SSESOpsConn0004").then(function () {
            Page.addConn("SSESOpsConn0004", "AbCdEfG:1234", "AAAAA", "bbbbb", false, true);
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.cancelConnYes("SSESOpsConn0004", "HiJkLmN:5678", "CCCCC", "ddddd", true, false);
        }).then(function () {
            Page.eleConnectionsLeftmenu.click();
        }).then(function () {
            globalCommons.waitForDisplayed(Page.eleSearchInput);
        }).then(function () {
            Page.eleSearchInput.clear().sendKeys("SSESOpsConn0004");
        }).then(function () {
            ...
            expect(message === 'SSESOpsConn0004').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
    ...
    // Connection Name: SSESOpsConn0005
    // Host (URL): HiJkLmN:5678
    // User Name: CCCCC
    // Password: ddddd
    // Use TLS Connection: selected
    ...
    it('Should add a connection, cancel the changes, then discard the cancel operation', function () {
        Page.delConnYes("SSESOpsConn0005").then(function () {
            Page.addConn("SSESOpsConn0005", "AbCdEfG:1234", "AAAAA", "bbbbb", false, true);
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.cancelConnNo("SSESOpsConn0005", "HiJkLmN:5678", "CCCCC", "ddddd", true, false);
        }).then(function () {
            return Page.eleConnNameInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'SSESOpsConn0005').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'HiJkLmN:5678').to.be.true;
    ...
    // Connection Name: SSESOpsConn0006
    // Host (URL): AbCdEfG:1234
    // User Name: AAAAA
    // Password: bbbbb
    // Use TLS Connection: not selected
    ...
    it('Should add a connection, make some changes, then reset it', function () {
        Page.delConnYes("SSESOpsConn0006").then(function () {
            Page.addConn("SSESOpsConn0006", "AbCdEfG:1234", "AAAAA", "bbbbb", false, true);
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.resetConn("SSESOpsConn0006", "HiJkLmN:5678", "CCCCC", "ddddd", true, false);
        }).then(function () {
            return Page.eleConnNameInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'SSESOpsConn0006').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'AbCdEfG:1234').to.be.true;
    ...
    // Connection Name: SSESOpsConn0007
    // Host (URL): AbCdEfG:1234
    // User Name: AAAAA
    // Password: bbbbb
    // Use TLS Connection: not selected
    ...
    it('Should add a connection to overwrite a connection, then confirm the overwrite operation', function () {
        Page.delConnYes("SSESOpsConn0007").then(function () {
            Page.addConn("SSESOpsConn0007", "AbCdEfG:1234", "AAAAA", "bbbbb", false, true);
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.addConn("SSESOpsConn0007", "HiJkLmN:5678", "CCCCC", "ddddd", true, false);
        }).then(function () {
            ...
            expect(message === 'SSESOpsConn0007').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'HiJkLmN:5678').to.be.true;
    ...
    // Connection Name: SSESOpsConn0008
    // Host (URL): HiJkLmN:5678
    // User Name: CCCCC
    // Password: ddddd
    // Use TLS Connection: selected
    ...
    it('Should add a connection to overwrite a connection, then discard the overwrite operation', function () {
        Page.delConnYes("SSESOpsConn0008").then(function () {
            Page.addConn("SSESOpsConn0008", "AbCdEfG:1234", "AAAAA", "bbbbb", false, true);
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.addConn("SSESOpsConn0008", "HiJkLmN:5678", "CCCCC", "ddddd", true, false);
        }).then(function () {
            ...
            Page.eleSearchInput.clear().sendKeys("SSESOpsConn0008");
        }).then(function () {
            Page.eleSearchIcon.click();
        }).then(function () {
            ...
            expect(message === 'SSESOpsConn0008').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'AbCdEfG:1234').to.be.true;
    ...
    it('Should add a connection, delete it, then confirm the delete operation', function () {
        Page.delConnYes("SSESOpsConn0009").then(function () {
            Page.addConn("SSESOpsConn0009");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.delConnYes("SSESOpsConn0009");
        }).then(function () {
            globalCommons.waitForDisplayed(Page.eleSearchInput);
        }).then(function () {
            Page.eleSearchInput.clear().sendKeys("SSESOpsConn0009");
        }).then(function () {
            Page.eleSearchIcon.click();
        }).then(function () {
    ...
    // Connection Name: SSESOpsConn0010
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Should add a connection, delete it, then discard the delete operation', function () {
        Page.delConnYes("SSESOpsConn0010").then(function () {
            Page.addConn("SSESOpsConn0010");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo, true, {timeout: 10000});
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.delConnNo("SSESOpsConn0010");
        }).then(function () {
            return Page.eleConnNameSearched.isPresent();
        }).then(function (result) {
    ...
    // Connection Name: SSESOpsConn0011
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Test CHECK & Connect button', function () {
        Page.delConnYes("SSESOpsConn0011").then(function () {
            Page.addConn("SSESOpsConn0011");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
    ...
    // Connection Name: SSESOpsConn0012
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: bbbbb
    // Use TLS Connection: not selected
    ...
    it('Test CHECK & Connect button with incorrect password', function () {
        Page.delConnYes("SSESOpsConn0012_Invalid_Password").then(function () {
            Page.addConn("SSESOpsConn0012_Invalid_Password", undefined, undefined, "bbbbb");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleSaveInfoClose.click();
    ...
    // Add a connection with correct host & password, incorrect username, then click 'CHECK' & 'Connect'
    // Connection Name: SSESOpsConn0013
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: AAAAA
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Test CHECK & Connect button with incorrect username', function () {
        Page.delConnYes("SSESOpsConn0013_Invalid_Username").then(function () {
            Page.addConn("SSESOpsConn0013_Invalid_Username", undefined, "AAAAA");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleSaveInfoClose.click();
    ...
    // Connection Name: SSESOpsConn0014
    // Host (URL): AbCdEfG:1234
    // User Name: AAAAA
    // Password: bbbbb
    // Use TLS Connection: not selected
    ...
    it('Test CHECK & Connect button with incorrect host', function () {
        Page.delConnYes("SSESOpsConn0014_Invalid_Host").then(function () {
            Page.addConn("SSESOpsConn0014_Invalid_Host", "AbCdEfG:1234", "AAAAA", "bbbbb");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleSaveInfoClose.click();
    ...
    // Connection Name: SSESOpsConn0015
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Test Audit button', function () {
        Page.delConnYes("SSESOpsConn0015").then(function () {
            Page.addConn("SSESOpsConn0015");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleSaveInfoClose.click();
    ...
    // Connection Name: SSESOpsConn0016
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Click Real Time menus with an available connection', function () {
        Page.delConnYes("SSESOpsConn0016").then(function () {
            Page.addConn("SSESOpsConn0016");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            ...
            expect(message === 'SSESOpsConn0016').to.be.true;
        }).then(function () {
            Page.eleEmsLeftmenu.click();
        }).then(function () {
            browser.sleep(500);
    ...
    // Connection Name: SSESOpsConn0017
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Submit Display commands with an available connection', function () {
        ...
        Page.delConnYes("SSESOpsConn0017").then(function () {
            Page.addConn("SSESOpsConn0017");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleConnectionsLeftmenu.click()
            ...
            Page.eleSearchInput.clear().sendKeys("SSESOpsConn0017");
        }).then(function () {
            Page.eleSearchIcon.click();
        }).then(function () {
    ...
    // Connection Name: SSESOpsConn0018
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Submit Update commands with an available connection', function () {
        var backspaceSeries = Array(40).join(protractor.Key.BACK_SPACE);
        var projectPath = process.cwd();
        Page.delConnYes("SSESOpsConn0018").then(function () {
            Page.addConn("SSESOpsConn0018");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleConnectionsLeftmenu.click()
            ...
            Page.eleSearchInput.clear().sendKeys("SSESOpsConn0018");
        }).then(function () {
            Page.eleSearchIcon.click();
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleConnNameSearched);
    ...
    it('Submit Initialization commands with an available connection', function () {
        var backspaceSeries = Array(40).join(protractor.Key.BACK_SPACE);
        var projectPath = process.cwd();
        Page.delConnYes("SSESOpsConn0019").then(function () {
            Page.addConn("SSESOpsConn0019");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleConnectionsLeftmenu.click()
            ...
            Page.eleSearchInput.clear().sendKeys("SSESOpsConn0019");
        }).then(function () {
            Page.eleSearchIcon.click();
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleConnNameSearched);
    ...
    // Connection Name: SSESOpsConn0020
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Submit Control commands with an available connection', function () {
        var backspaceSeries = Array(40).join(protractor.Key.BACK_SPACE);
        var projectPath = process.cwd();
        Page.delConnYes("SSESOpsConn0020").then(function () {
            Page.addConn("SSESOpsConn0020");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleConnectionsLeftmenu.click()
            ...
            Page.eleSearchInput.clear().sendKeys("SSESOpsConn0020");
        }).then(function () {
            Page.eleSearchIcon.click();
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleConnNameSearched);
    ...
    // Connection Name: SSESOpsConn0021
    // Host (URL): defined in conf.js (EndpointSSES.url)
    // User Name: defined in conf.js (EndpointSSES.userid)
    // Password: defined in conf.js (EndpointSSES.password)
    // Use TLS Connection: not selected
    ...
    it('Submit invalid commands with an available connection', function () {
        var backspaceSeries = Array(40).join(protractor.Key.BACK_SPACE);
        var projectPath = process.cwd();
        Page.delConnYes("SSESOpsConn0021").then(function () {
            Page.addConn("SSESOpsConn0021");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            Page.eleConnectionsLeftmenu.click()
            ...
            Page.eleSearchInput.clear().sendKeys("SSESOpsConn0021");
        }).then(function () {
            Page.eleSearchIcon.click();
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleConnNameSearched);
    ...
    it('Test field "Connection Name"', function () {
        Page.delConnYes("SSESOpsConn0022_@#$_3333333333444444444").then(function () {
            Page.addConn("SSESOpsConn0022_@#$_3333333333444444444");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            expect(message === 'SSESOpsConn0022_@#$_3333333333444444444').to.be.true;
        }).then(function () {
            Page.delConnYes("SSESOpsConn0023_@#$_3333333333444444444");
        }).then(function () {
            Page.addConn("SSESOpsConn0023_@#$_33333333334444444444");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            expect(message === 'SSESOpsConn0023_@#$_3333333333444444444').to.be.true;
        });
    });
    ...
    it('Test field "Host(URL)"', function () {
        Page.delConnYes("SSESOpsConn0024").then(function () {
            Page.addConn("SSESOpsConn0024", "AAAAAAAAAABBBBBBBBBBCCCCCCCCCCDDDDDDDDDDEEEEEEEEEEaaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeee@@@@@@@@@@##########$$$$$$$$$$&&&&&&&&&&??????????11111111112222222222333333333344444444445555555555111111111122222222223333333333444444444455555555551111");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.delConnYes("SSESOpsConn0025");
        }).then(function () {
            Page.addConn("SSESOpsConn0025", "AAAAAAAAAABBBBBBBBBBCCCCCCCCCCDDDDDDDDDDEEEEEEEEEEaaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeee@@@@@@@@@@##########$$$$$$$$$$&&&&&&&&&&??????????111111111122222222223333333333444444444455555555551111111111222222222233333333334444444444555555555511111");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
    ...
    it('Test field "User Name"', function () {
        Page.delConnYes("SSESOpsConn0026").then(function () {
            Page.addConn("SSESOpsConn0026", undefined, "@#$%&/!^");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.delConnYes("SSESOpsConn0027");
        }).then(function () {
            Page.addConn("SSESOpsConn0027", undefined, "AbC4Ef7hIj");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
    ...
    it('Test field "Password"', function () {
        Page.delConnYes("SSESOpsConn0028").then(function () {
            Page.addConn("SSESOpsConn0028", undefined, undefined, "!@#$%^&*()<>?/a1");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            Page.delConnYes("SSESOpsConn0029");
        }).then(function () {
            Page.addConn("SSESOpsConn0029", undefined, undefined, "QWERTasdfg1234567");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
    ...
    // Test field 'Connection Details panel' -> 'Substation Endpoint'
    // Related jiras: ZWUI-900(fixed)
    it('Test field "Substation Endpoint"', function () {
        Page.delConnYes("SSESOpsConn0030").then(function () {
            Page.delConnYes("SSESOpsConn0031");
        }).then(function () {
            globalCommons.waitForClickable(globalNaviPage.eleDefineMenu)
        }).then(function () {
            globalNaviPage.eleDefineMenu.click();
        }).then(function () {
            definePage.delEndpointSsYes("EndpointSSA0001");
        }).then(function () {
            definePage.delEndpointSsYes("EndpointSSA0002");
        }).then(function () {
            definePage.addEndpointSs("EndpointSSA0001");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            definePage.addEndpointSs("EndpointSSA0002_@#$23333333333444444444", undefined, undefined, undefined, undefined, true);
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            ...
            Page.addConn2("SSESOpsConn0030", "EndpointSSA0001");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            expect(message === 'SSESOpsConn0030').to.be.true;
        }).then(function () {
            return Page.eleSsEndpointInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'EndpointSSA0001').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
            expect(message === browser.params.endpointSSES.url).to.be.true;
            ...
            Page.addConn2("SSESOpsConn0031", "EndpointSSA0002_@#$23333333333444444444");
        }).then(function () {
            globalCommons.waitForElementPresent(Page.eleSaveInfo);
        }).then(function () {
            return Page.eleSaveInfo.getText();
            ...
            expect(message === 'SSESOpsConn0031').to.be.true;
        }).then(function () {
            return Page.eleSsEndpointInput.getAttribute("value");
        }).then(function (message) {
            expect(message === 'EndpointSSA0002_@#$23333333333444444444').to.be.true;
        }).then(function () {
            return Page.eleHostInput.getAttribute("value");
        }).then(function (message) {
            expect(message === browser.params.endpointSSES.url).to.be.true;
