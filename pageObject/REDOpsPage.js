...
var REDOpsPage = (function () {
     ...
     * true: selected
     */
    REDOpsPage.prototype._tls = function (tls) {
     ...
     * true: selected
     */
    REDOpsPage.prototype._selectionlist = function (selectionlist) {
        var deferred = protractor.promise.defer(), that = this;
     ...
     *
     */
    REDOpsPage.prototype.addConn = function (connname, host, username, password, tls, selectionlist) {
        var deferred = protractor.promise.defer(), that = this;
        host = host || browser.params.endpointRED.url;
        username = username || browser.params.endpointRED.userid;
    ...
    /**
     * The function is used for add a connection (The TCP connection parameter values come from RED Endpoint).
     *
     */
    REDOpsPage.prototype.addConn2 = function (connname, redEndpoint, selectionlist) {
        var deferred = protractor.promise.defer(), that = this;
        selectionlist = selectionlist === undefined ? "true" : selectionlist;
        ...
        globalCommons.waitForElementPresent(that.eleScreenElement, true, {timeout: 10000}).then(function () {
            ...
            globalCommons.waitForClickable(that.eleRedEndpointPickButton);
        }).then(function () {
            that.eleRedEndpointPickButton.click();
        }).then(function () {
            globalPage.entitySelect(redEndpoint);
        }).then(function () {
            that._selectionlist(selectionlist);
        }).then(function () {
     ...
     *
     */
    REDOpsPage.prototype.delConnYes = function (connname) {
        var deferred = protractor.promise.defer(), that = this;
     ...
     *
     */
    REDOpsPage.prototype.delConnNo = function (connname) {
        var deferred = protractor.promise.defer(), that = this;
     ...
     *
     */
    REDOpsPage.prototype.replicateConn = function (connname) {
        var deferred = protractor.promise.defer(), that = this;
     ...
     *
     */
    REDOpsPage.prototype.updateConn = function (connname, host, username, password, tls, selectionlist) {
        var deferred = protractor.promise.defer(), that = this;
        host = host || browser.params.endpointRED.url;
        username = username || browser.params.endpointRED.userid;
        password = password || browser.params.endpointRED.password;
     ...
     *
     */
    REDOpsPage.prototype.cancelConnYes = function (connname, host, username, password, tls, selectionlist) {
        var deferred = protractor.promise.defer(), that = this;
        host = host || browser.params.endpointRED.url;
        username = username || browser.params.endpointRED.userid;
        password = password || browser.params.endpointRED.password;
     ...
     *
     */
    REDOpsPage.prototype.cancelConnNo = function (connname, host, username, password, tls, selectionlist) {
        var deferred = protractor.promise.defer(), that = this;
        host = host || browser.params.endpointRED.url;
        username = username || browser.params.endpointRED.userid;
        password = password || browser.params.endpointRED.password;
     ...
     *
     */
    REDOpsPage.prototype.resetConn = function (connname, host, username, password, tls, selectionlist) {
        var deferred = protractor.promise.defer(), that = this;
        host = host || browser.params.endpointRED.url;
        username = username || browser.params.endpointRED.userid;
        password = password || browser.params.endpointRED.password;
